...
class MinesweeperAI():
    ...
    def update_knowledge(self):
        """
        Update knowledge base by marking cells as safe or as mines
        if it can be concluded based on the AI's knowledge base.
        """
        changes = True
        while changes:
    ...
    def infer_new_knowledge(self):
        """
        Add any new sentences to the AI's knowledge base if they can be inferred
    ...
    def make_random_move(self):
        ...
        possible_moves -= self.moves_made | self.mines
